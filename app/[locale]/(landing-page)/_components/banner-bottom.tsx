...
const BannerBottom = () => {
  ...
  return (
    <div className={cn('mt-16 bg-orange-100', theme === 'dark' && 'bg-slate-500')}>
      <div className='px-4 lg:px-32 flex justify-center py-8 lg:py-16'>
        <div>
          <Image className='hidden sm:flex' height={350} width={450} alt='banner' src='/banner-bottom.webp' />
        </div>
        <div className='flex flex-col gap-4 w-[400px]'>
          <h1 className='font-bold text-2xl md:text-3xl lg:text-4xl'>Become an instructor</h1>
